    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                """sudo_timesteps = -1
                while sudo_timesteps < 0:
                    sudo_timesteps = torch.normal(0, 5, (1,)) / 10 + step / args.max_train_steps
                
                sudo_timesteps = (sudo_timesteps.clamp_(0.001, 1) * 1000).long()
                #torch.randn(,)
                timesteps[0] = 1000 - sudo_timesteps"""
                ...
                rnd = (rnd - step / args.max_train_steps) * 1.0
                rnd[1] = 0
                ...
                with torch.no_grad():
                    ...
                    control_addition = controlnet(noisy_latents, timesteps, mixed_prompt, hed).mid_block_res_sample
                ...
                # no_grad 會好一些，用<new1> man作為controlnet輸入過強，用man有些弱，換成插值, 
