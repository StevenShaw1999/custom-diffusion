...
def main(args):
    ...
    unet = create_custom_diffusion_decouple(unet, args.freeze_model)
    ...
    if args.train_text_encoder or args.modifier_token is not None:
        ...
        unet, text_encoder, controlnet, apply_hed = accelerator.prepare(
            unet, text_encoder, controlnet, apply_hed
        )
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                """if global_step == 120:
                    for num, param in enumerate(lora_layers.parameters()):
                        print(param)
                        if num == 1:
                            break"""
